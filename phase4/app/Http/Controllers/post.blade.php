...
<div class="container-fluid" style="margin-top: 300px">
    ...
    <div class="row">
	    ...
	    @csrf
            ...
            <input name="textbook_name" type="text" class="form-control" placeholder="Required" required >
            <br>
            <h6> Textbook Condition:
            </h6>
            <div class="dropdown">

                <select name= "textbook_condition" class="btn btn-outline-primary dropdown-toggle" data-toggle="dropdown" required >
            ...
            <div class="dropdown">
                ...
                <select name="course" class="btn btn-outline-primary dropdown-toggle"  data-toggle="dropdown" required>
            ...
            <input type="number" name="course_num" class="form-control" required>
            <br>
            <h6> Description:
            </h6>
