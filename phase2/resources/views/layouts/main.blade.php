...
<div class="container-fluid">
    ...
    <!--                    Change to a real button in future version-->
                        <li>
                            <a class="btn btn-primary" href="listing" style="padding: 12px 20px; border-radius: 4px">
                            Post
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul>
                                ...
                                <li><a class="dropdown-item" href="contact_us">Report Issue</a></li>
                            </ul>
                        </li>
                        <!--                    Change to a real button in future version-->
                        <li>
                            <a class="btn btn-danger my-2 my-sm-0" style="padding: 12px 20px; border-radius: 4px" href="landing">
                            Log out
                            </a>
                        </li>
                    </ul>
    ...
    <div class="row" style="margin-top: 60px">
        <div class="col-md-12">
            <div class="row" style="height: 100%">
                <div class="col-md-4">
                    <iframe src="cards"></iframe>
                </div>
                <div class="col-md-8" style="height: 100%">
                    <iframe src="details" id="detail"></iframe>
                </div>
            </div>
