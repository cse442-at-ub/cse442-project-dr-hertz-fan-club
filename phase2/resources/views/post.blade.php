    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse">
                ...
                <a class="btn btn-danger my-2 my-sm-0 ml-auto"
                   style="margin-left: 10px; padding: 12px 20px; border-radius: 4px" href="main">
                    Cancel
                </a>
        </div>
    </nav>
...
<div class="container-fluid" style="margin-top: 150px">
    ...
    <div class="row">
        ...
        <div class="col-md-6" id="textbookListing">
            ...
            <input class="form-control" id="inputCourseNumber">
            <br>
            <h6> Description:
            </h6>
            <textarea class="form-control" id="textbookDescription" rows="10" required></textarea>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
    ...
    <div class="row">
        ...
        <div class="col-md-6" id="roommateListing">
            ...
            <label for="roommateDescription"></label><textarea class="form-control" id="roommateDescription" rows="10"
                                                               required></textarea>
        </div>
        <div class="col-md-3">
        </div>
