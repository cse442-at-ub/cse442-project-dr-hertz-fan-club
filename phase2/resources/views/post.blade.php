    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse">
                ...
                <a class="btn btn-danger my-2 my-sm-0 ml-auto"
                   style="margin-left: 10px; padding: 12px 20px; border-radius: 4px" href="{{route('main')}}">
                    Cancel
                </a>
        </div>
    </nav>
        ...
        <div class="col-md-6" id="textbookListing">
            ...
            <form role="form">
                ...
                <div class="dropdown">
                    ...
                    <select class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown" id="condition">
                ...
                <div class="dropdown">
                    ...
                    <select class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown" id="course">
        ...
        <div class="col-md-6" id="housingListing">
            ...
            <form role="form">
                ...
                <div class="dropdown">
                    ...
                    <select class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown" id="housingType">
                ...
                <div class="dropdown">
                    ...
                    <select class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown" id="bedrooms">
                ...
                <div class="dropdown">
                    ...
                    <select class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown" id="bathrooms">
                        <option class="dropdown-item" value="" selected disabled> Select A Number </option>
                        <option class="dropdown-item" value="1"> 1 </option>
                        <option class="dropdown-item" value="2"> 2 </option>
                        <option class="dropdown-item" value="3"> 3 </option>
        ...
        <div class="col-md-6" id="roommateListing">
            ...
            <form role="form">
                ...
                <div class="dropdown">
                    ...
                    <select class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown" id="roommates">
                        <option class="dropdown-item" value="" selected disabled> Select A Number </option>
                        <option class="dropdown-item" value="1"> 1 </option>
                        <option class="dropdown-item" value="2"> 2 </option>
                        <option class="dropdown-item" value="3"> 3 </option>
                ...
                <div class="dropdown">
                    ...
                    <select class="btn btn-outline-primary dropdown-toggle" type="button" data-toggle="dropdown" id="preference">
                ...
                <label for="roommateDescription"></label><textarea class="form-control" id="roommateDescription" rows="10" placeholder="Required"></textarea>
                <br>
                <button type="submit" class="btn btn-success btn-block">
